...
class MapillaryDataset(BaseSegDataset):
    """Mapillary dataset.
    """
...
class MapillaryHack(BaseTransform):
    ...
    def transform(self, results: dict) -> dict:
        if 'vistas' not in results['seg_map_path']:
            return results

        gt_map = results['gt_seg_map']
        # others -> 255
